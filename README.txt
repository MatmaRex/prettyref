...
Web interface available at http://prettyref.heroku.com/ (pl.wiki-only).
...
Narzędzie dostępne online na http://prettyref.heroku.com/ (tylko pl.wiki).
...
Code released under CC-BY-SA 3.0, by w:pl:User:Matma Rex.